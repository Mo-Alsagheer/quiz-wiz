  ...
  async learnerDashboard(
    ...
    const upcomingQuizzes =
      await this.quizModel
        ...
        .limit(5)
        .select(
          'title scheduledDateTime totalEnrolledStudents',
        );
    ...
    return {
      upcomingQuizzes: upcomingQuizzes.map(
        (quiz) => ({
          id: quiz._id,
          title: quiz.title,
          scheduledDateTime:
